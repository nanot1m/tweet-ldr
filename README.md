...
Tweet LDR is a lightweight Chrome extension for saving useful media from X/Twitter posts. It adds compact controls directly into each tweet so you can download videos when possible or copy a polished tweet screenshot.
...
![Tweet LDR screenshot export](assets/screenshots/tweet-2066965242488254725.png)
...
- Copies styled tweet screenshots as transparent PNGs with rounded corners and a soft shadow.
...
For screenshots, it captures the visible tab, crops to the tweet bounds, renders the result onto a transparent canvas with rounded clipping and shadow, and copies the PNG to the clipboard.
...
- Screenshot capture only includes the visible viewport. Scroll long tweets fully into view before copying.
